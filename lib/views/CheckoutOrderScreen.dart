...
import 'package:Delivery/controllers/OrderController.dart';
import 'package:Delivery/models/Cart.dart';
import 'package:Delivery/models/Coupon.dart';
import 'package:Delivery/models/MyResponse.dart';
import 'package:Delivery/models/Order.dart';
import 'package:Delivery/models/Product.dart';
import 'package:Delivery/models/Shop.dart';
import 'package:Delivery/models/UserAddress.dart';
import 'package:Delivery/services/AppLocalizations.dart';
import 'package:Delivery/utils/ColorUtils.dart';
import 'package:Delivery/utils/DistanceUtils.dart';
import 'package:Delivery/utils/Generator.dart';
import 'package:Delivery/utils/ProductUtils.dart';
import 'package:Delivery/utils/SizeConfig.dart';
import 'package:Delivery/views/CouponScreen.dart';
import 'package:Delivery/views/OrderScreen.dart';
import 'package:Delivery/views/addresses/AddAddress.dart';
  ...
  void _calculateDistance() {
    if (userAddresses.length != 0) {
      ...
      if (distanceInMeter <= shop.deliveryRange) {
        setState(() {
          validForDelivery = true;
          deliveryFee = shop.minimumDeliveryCharge +
              (distanceInMeter * shop.deliveryCostMultiplier / 1000);
        });
      } else {
        setState(() {
