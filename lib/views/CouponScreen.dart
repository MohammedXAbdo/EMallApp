...
import 'package:Delivery/controllers/CouponController.dart';
...
class _CouponScreenState extends State<CouponScreen> {
  ...
  _loadCouponData() async {
    ...
    MyResponse<List<Coupon>> myResponse =
        await CouponController.getCouponForShop(widget.shopId);
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: isValidate
                ? Container()
                : Text(
                    Translator.translate("minimum_order_value_is") +
                        " " +
